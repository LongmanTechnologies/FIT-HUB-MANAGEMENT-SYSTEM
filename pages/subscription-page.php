...
<head>
    ...
    <link rel="stylesheet" href="../support/css/subscription-page.css">
...
<body>
    ...
    <div class="container">
        <section class="content">
            <div class="front">
                <marquee scrollamount="100" behavior="slide" direction="down" height="70%">
                    <p>JOIN US TODAY</p>
                    <p>For better</p>
                </marquee>
            </div>
            <div class="packages">
                <div>
                    <a href="">
                        <div class="package1">
                            <h1>Gold Plan</h1>
                            <h2>$3000 <sub>/mo</sub></h2>
                            <ul>
                                <li>Access to at of our brach gym</li>
                                <li>Unlimited guest privileges</li>
                                <li>Free access to the swimming pool</li>
                                <li>50% off drinks</li>
                                <li>You get to act as our gym ambasaders</li>
                ...
                <div>
                    <a href="">
                        <div class="package1">
                            <h1>Basic Plan</h1>
                            <h2>$1000 <sub>/mo</sub></h2>
                            <ul>
                                <li>Limited access to gym equipments</li>
                                <li>50% off drinks</li>
                            </ul>
                        </div>
                    </a>
