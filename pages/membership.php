...
<body id="dark">
    <div class="container">
        ...
        <div class="card">
            <h2>Gym Membership Subscription Form</h2>
            ...
            <div class="form-popup" id="myForm">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    echo '<script>alert("Thank you for subscribing to our gym membership! \n Your subscription request has been successfully received.");
                    ...
                    <form action="" method="post">
                        ...
                        <fieldset id="terms" class="terms">
                            ...
                            <label>
                                ...
                                I agree to abide by the rules and regulations of the gym. I understand that the membership fee is non-refundable.
                            </label><br>

                            <label>
                                <input type="checkbox" name="consent" value="consent" required>
                                I consent to receive communication from the gym regarding membership updates, promotions, and events via the provided email address and phone number.
                            </label><br>
                        </fieldset>
